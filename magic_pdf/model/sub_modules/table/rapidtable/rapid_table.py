...
class RapidTableModel(object):
    def __init__(self, model_path, ocr_engine, table_sub_model_name='slanet_plus',
        ...
        if self.enable_ov:
            ...
            sess_opt.use_per_session_threads = True
            self.table_model.table_structure.session.session = ort.InferenceSession(slanet_plus_model_path, sess_options=sess_opt, providers=["CPUExecutionProvider"])
