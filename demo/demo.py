...
os.environ['MINERU_PDF_RENDER_THREADS'] = '8'
...
def do_parse(
    ...
    infer_results, all_image_lists, all_pdf_docs, lang_list, ocr_enabled_list = pipeline_doc_analyze(pdf_bytes_list, p_lang_list, enable_ov, Layout_infer_type, MFD_infer_type, MFR_enc_infer_type, MFR_dec_infer_type, OCR_det_infer_type, OCR_rec_infer_type, wired_table_type, WirelessTable_type, img_orientation_cls_type, table_cls_type, nstreams,parse_method=parse_method, formula_enable=formula_enable,table_enable=table_enable)
...
def parse_doc(
    ...
    try:
        ...
        do_parse(
            ...
            wired_table_type = wired_table_type,
            WirelessTable_type = WirelessTable_type,
            img_orientation_cls_type = img_orientation_cls_type,
            table_cls_type = table_cls_type,
            nstreams = nstreams,
            parse_method=method,
